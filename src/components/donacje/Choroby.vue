<template>
    <div>
        <h1 class="page-title">Informacja o chorobach zakaźnych dla krwiodawców</h1>
<b>O czym musisz wiedzieć przed oddaniem krwi.odzin:</b>
<br>
...
<br>
<b>Ryzyko stwarzają:</b>
<ul>
    <li>Wcześniej lub aktualnie stosowane narkotyki w postaci zastrzyków.</li>
    <li>Kontakty seksualne z osobami stosującymi narkotyki w postaci zastrzyków.</li>
    <li>Kontakty seksualne z wieloma partnerkami/partnerami.</li>
    <li>Kontakty seksualne z partnerem/partnerką, których znasz od niedawna.</li>
    <li>Kontakty seksualne w celu zarobkowym.</li>
    <li>Kontakty seksualne z osobami, u których testy w kierunku AIDS, kiły lub żółtaczki zakaźnej B lub C wypadły dodatnio.</li>
</ul>
<br>
