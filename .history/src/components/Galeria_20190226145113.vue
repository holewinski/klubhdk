...
export default {
  ...
  created(){
    ...
    this.list.forEach((item) => { 
        item.url.photo = 'http://vtest.klubhdkferstena.pl/asstes/photo/'+item.title+'/'+item.title;  console.log(item.url.photo)
        item.url.thumb = 'http://vtest.klubhdkferstena.pl/asstes/thumb/'+item.title+'/'+item.title;  console.log(item.url.thumb)
        })
  }
