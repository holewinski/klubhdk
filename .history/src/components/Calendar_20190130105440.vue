<template>
    <div class="calendar">
        ...
        <transition name="slide-fade" v-if=firstRender>
                <div class="event" 
                  v-show="eventShow" 
                  :key="'event-box'"
                  :class="activeEvent.typ.key">
                    ...
                    <div class="box">
                        ...
                        <div class="inside-box">
                            ...
                            <p class="desc">{{ activeEvent.typ.opis}}</p>
                        </div>
    ...
    data(){
        return {
            ...
            miejsca:{   
                ...
                utk:{
                    key:'UTK',
                    fram:`<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d9776.914304168931!2d20.9727229!3d52.2210649!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x23fd2555a03d003!2sUrz%C4%85d+Transportu+Kolejowego!5e0!3m2!1spl!2spl!4v1548835895212" width="800" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>`,
            ...
            typy:{
                donacja:{
                    key:'donacja',
                    name:'Oddawanie krwi',
                    opis:'Cykliczna klubowa akcja oddawnia krwi',
            ...
            return [
                {
                    ...
                    month:10,
                    day:28, 
                    typ:this.typy.spotkanie,
                    lokal:this.miejsca.nowogrodzka
                },
                {
                    key:'a',
                    year:2018,
                    month:10,
                    day:22, 
                    typ:this.typy.donacja,
                    lokal:this.miejsca.centralny
                },
                ...
                
                {
                    ...
                    month:10,
                    day:12, 
                    typ:this.typy.impreza,
                    lokal:this.miejsca.utk
                },
                {
                    key:'d',
                    year:2018,
