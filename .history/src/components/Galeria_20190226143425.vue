...
export default {
  ...
  created(){
    ...
    this.list.forEach((item) => { 
        item.url.photo = 'http://vtest.klubhdkferstena.pl/photo/'+item.title+'/'+item.title;  console.log(item.url.photo)
        item.url.thumb = 'http://vtest.klubhdkferstena.pl/thumb/'+item.title+'/'+item.title;  console.log(item.url.thumb)
        })
  }
