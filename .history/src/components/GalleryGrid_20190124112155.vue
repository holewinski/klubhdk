<template>
    <div id="gallery">
        ...
        <div id="pages">
            <font-awesome-icon :icon="['fas', 'caret-left']" @click="changePage(-1)" :class="{ 'un-active' : page+1 > numOfPages }"/> 
            <div>{{page}}</div>
            <font-awesome-icon :icon="['fas', 'caret-right']" @click="changePage(1)" :class="{ 'un-active' : page+1 > numOfPages }"/> 
        </div>
