...
export default {
          ...
          list:[
              {
                  ...
                  url:"http://vtest.klubhdkferstena.pl/photo/VIII Kongres SHDK RP/VIII Kongres SHDK RP",
  ...
  created(){
      axios.get(this.gallery)
        .then()
    this.list.forEach(function() ={ this.url.photo = 'http://vtest.klubhdkferstena.pl/photo'+this.title+'/'+this.title;  console.log(this.url.photo)})
  }
