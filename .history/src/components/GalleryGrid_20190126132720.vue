<template>
    <div id="gallery">
        ...
        <transition-group name="slide-fade" tag="div" id="thumbnail-grid">
            <div class="thumbnail" v-for="(photo, id) in onThisPage" :key="id" @click="slideShow = true, firstRender = true, activeSlide = id+1">
