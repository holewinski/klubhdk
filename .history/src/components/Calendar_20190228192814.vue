        ...
        <div  class="cal-days" :key="activeMonth+'month'">
            ...
            :key="months[prevMonth]+'-'+p">
             ...
             :class="{ 
                ...
                v-if="i[0] == 'e'"  
                :key="'event-'+i[1]" >
                    <div @click="eventShow = true, activeEvent = actualEvents[i[2]], firstRender = true" class="number">
                        {{ i[1] }}
                    </div>
...
export default {
    ...
    computed:{
        ...
        // },
        actualEvents(){
            const a = new Function('object', 'return object.r'+this.activeYear.toString()+';');
    ...
    methods:{
        ...
        createEventsArrary(){
            this.eventsArray = []
            for(var e = 0; e < this.actualEvents.length ; e++){
               
                        switch (this.actualEvents[e].month){
            ...
            for(var z = 1 ; z <= this.numberOfDays ; z++){
                switch(this.eventsArray.length){
                    case 0:
                        ...
                        break;
                    default:
                        switch(this.actualEvents[this.eventsArray[0]].day){
                            case z:
