            ...
            <div :class="{loading : isLoading == true, mouseover : mouseover }" id="slide">
                ...
                <div id="panel">
                    ...
                    <font-awesome-icon :icon="['fas', 'times']" @click="nullGallery()"/>
                     <span class="set-time" >
                        <font-awesome-icon :icon="['fas', 'minus-square']" @click="slideShowPlay = false"/>
                        <font-awesome-icon :icon="['fas', 'clock']" @click="slideShowPlay = false"/>
                        {{ playTime}}
                        <font-awesome-icon :icon="['fas', 'plus-square']" @click="slideShowPlay = false"/>
