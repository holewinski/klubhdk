<template>
    <div id="gallery">
        ...
        <div id="pages">
            <font-awesome-icon :icon="['fas', 'caret-left']" @click="changePage(-1)"/> 
            <div>{{page}}</div>
            <font-awesome-icon :icon="['fas', 'caret-right']" @click="changePage(1)"/> 
        </div>
...
export default {
    ...
    methods:{
        changePage(a){
            if(this.page-1 == 0 || this.page == this.numOfPages){
